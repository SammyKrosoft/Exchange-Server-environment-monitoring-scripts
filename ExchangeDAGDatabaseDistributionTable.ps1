...
$SMTPServer1 = "E2016-02"
$SMTPServer2 = "E2016-01"
$SMTPServer3 = "E2016-03"

$From = "noreply@CanadaSam.ca"
$Recipient = "Administrator@CanadaSam.ca"

#--------------------
# End of to be customized:
#--------------------
...
$filename = "$($CurrentScriptLocation)"+ "\Email_Services___DAG_Layout_Report.htm"
...
<# Pushed at the beginning of the e-mail
$SMTPServer1 = "E2016-02"
$SMTPServer2 = "E2016-01"
$SMTPServer3 = "E2016-03"
...
$Subject = "Email Services - DAG Layout Report - $(Get-Date -f 'yyyy-MM-dd')"

if (Test-Connection $SMTPServer1 -Quiet)

{Send-MailMessage -from $From -to $Recipient -subject $Subject -SMTPServer $SMTPServer1 -Attachments $fileName -BodyAsHtml -Body $output}

elseif (Test-Connection $SMTPServer2 -Quiet)

{Send-MailMessage -from $From -to $Recipient -subject $Subject -SMTPServer $SMTPServer2 -Attachments $fileName -BodyAsHtml -Body $output}

else 
 
{Send-MailMessage -from $From -to $Recipient -subject $Subject -SMTPServer $SMTPServer3 -Attachments $fileName -BodyAsHtml -Body $output}
